...
class SoilGrids:
    ...
    FC(self, geometry: RasterGeometry = None, resampling: str = None) -> Raster
        Processes the field capacity soil data file and returns the processed rasters.
    WP(self, geometry: RasterGeometry = None, resampling: str = None) -> Raster
        Processes the WP soil data file and returns the processed rasters.
    """
    ...
    def WP(self,
           ...
           resampling: str = None) -> Raster:
        """
        Processes the wilting point soil data file and returns the processed rasters.
